...
.fade-carousel .slides .slide-1 {
  background-image: url(https://images7.alphacoders.com/596/596343.jpg); 
}
.fade-carousel .slides .slide-2 {
  background-image: url(http://www.italia.it/fileadmin/src/img/cluster_gallery/mangiare_bere/la_pizza/_0004_pizza_focaccia.jpg);
}
.fade-carousel .slides .slide-3 {
  background-image: url(https://media.istockphoto.com/photos/slice-of-pizza-cheese-crust-seafood-topping-sauce-with-bell-pepper-picture-id835271096?k=6&m=835271096&s=612x612&w=0&h=Q-Ue-Pchq7x9GanPLLJ8vEh6MTgoH3yZW1JXbuTUvDI=);
}
                ...
                <div class="collapse navbar-collapse js-navbar-collapse">
                    <ul class="nav navbar-nav navbar-left">
                      <a class="navbar-brand" href="#">
                            <img height="20" width="20" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQkKkyldVMQgodppmjiucmWfRYoLVA25LYD2I4-p51VZ6OEiMuaTg" class="img-responsive pull-left" alt="Responsive image">
                           Astral Pizza</a>
                       ...
                       <!-- <a href="#" class="dropdown-toggle" data-toggle="dropdown">Men <span class="caret"></span></a>        
                        ...
                        <ul class="dropdown-menu mega-dropdown-menu">
                          <li class="col-sm-3">
                              ...
                              <li><a href="Liste_de_Pizza_User.php">Menu</a></li>
                              <li><a href="Commande.php">Your Order</a></li>
    ...
    <nav id="sidebar-wrapper">
      <ul class="sidebar-nav">
        ...
        <li class="sidebar-brand">
          <a href="#top">Slid-up <strong>For More Pizza</strong></a>
        </li>
        <li>
          <a href="Utilisateur.php" title="Go to Top">Home</a>
        </li>
        <li>
          <a href="About.php" title="Go to About Us section">About</a>
        </li>
    
        <li>
          <a href="<?= $pathFor['logout'] ?>" title="Navigate to 'Our Services' section">LOG-OUT</a>
        </li>
     
        <li>
          <a href="/blog" title="Our Blog">Contact-Us</a>
        </li>
                ...
                <div class="carousel-inner">
                    <div class="item slides active">
                        <div class="slide-1"></div>
                            <div class="hero">
                                <hgroup>
                                    <h1>Welcome to Astral Pizza</h1>        
                                    <h3>Your Favorit Pizza Are here</h3>
                                </hgroup>
                        </div>
                    </div>
 ...
 <body id="page-top" name="page-top" class="active">
                      ...
                      <!--<li class="dropdown mega-dropdown">
                        ...
                        <ul class="dropdown-menu mega-dropdown-menu">
                          <li class="col-sm-3">
                              <ul>
                              <li class="dropdown-header">Pizza</li>
                              <li><a href="Liste_de_Pizza_Admin.php">List of the Pizza</a></li>
                                            <li><a href="Ajout_Pizza.php">ADD a Pizza</a></li>
                                            <li><a href="Supp_Pizza.php">Delete Pizza</a></li>
                                              <li><a href="Modif_Pizza.php">Modify Pizza</a></li>

                              <li class="divider"></li>
                              <li class="dropdown-header">Orders</li>
                                          <li><a href="Liste_de_commandes_Admin.php">List of the Orders</a></li>
                                          <li><a href="Modif_Statut.php">Modify Statut_Order</a></li>

                            </ul>
                          </li>
                          <li class="col-sm-3">
                            <ul>
                              <li class="dropdown-header">Extra Charge</li>
                              <li><a href="Supplm_Pizza.php">List of Extra Charge</a></li>
                              <li><a href="Ajout_Supplement.php">ADD Extra Charge</a></li>
                              <li><a href="Modif_Supplement.php">Modify Extra Charge</a></li>
                              <li><a href="Supp_Supplm.php">Delete Extra Charge</a></li>                            
                      ...
                      <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                          ...
                          <ul class="dropdown-menu" role="menu">
                            ...
                            <li><a href="#">Something else here</a></li>
                            <li class="divider"></li>
                            <li><a href="<?= $pathFor['logout'] ?>" title="Logout">LOGOUT</a></li>
                          </ul>
                        </li>
                        <li><a href="#">My cart (0) items</a></li>
                      </ul>-->
    ...
    <nav id="sidebar-wrapper">
      <ul class="sidebar-nav">
        <a id="menu-close" href="#" class="btn btn-danger pull-right hidden-md hidden-lg toggle"><i class="fa fa-times"></i></a>
        <li class="sidebar-brand">
          <a href="#top">Slid-up <strong></strong></a>
        </li>
        <li>
          <a href="Administrateur.php" title="Go to Top">Home</a>
        </li>
        <li>
          <a href="about.php" title="Go to About Us section">About</a>
        </li>
                        ...
                        <div class="slide-1"></div>
                            <div class="hero">
                                <hgroup>
                                    ...
                                    <h1>Welcome to Your Astral Pizza</h1>        
                                    <h3>Your Pizza Still The Best</h3>
                                </hgroup>
